<template>
	<mescroll-uni @init="mescrollInit" :up="upOption" :down="downOption" @down="downCallback" @up="upCallback">
		<!--header end-->
		<view class="list" :style='{"padding":"60rpx 20rpx","flex":"1"}'>
			<view v-for="(item,index) in list " v-bind:key="index" :style='{"border":"0px solid #ddd","padding":"30rpx","margin":"0 0 20rpx","borderRadius":"0px","background":"#fff","display":"flex","width":"100%","justifyContent":"space-between"}'>
				...
				<view :style='{"width":"calc(100% - 216rpx)"}'>
					<view :style='{"margin":"0 0 16rpx","overflow":"hidden","color":"#000","maxHeight":"96rpx","width":"100%","fontSize":"30rpx","lineHeight":"48rpx"}'>{{item.title}}</view>
		...
		<!--list end-->
		<button :style='{"padding":"0 40rpx","boxShadow":"none","margin":"40rpx 20rpx 40rpx 0","color":"#fff","textAlign":"center","right":"12rpx","float":"right","borderRadius":"0px","top":"120rpx","background":"#03b882","width":"auto","lineHeight":"72rpx","position":"absolute","height":"72rpx","zIndex":"999"}' @click="onUpdateTap()">新增</button>
	</mescroll-uni>
</template>
