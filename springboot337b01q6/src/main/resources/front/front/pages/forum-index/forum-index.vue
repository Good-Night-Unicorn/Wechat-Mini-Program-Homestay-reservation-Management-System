<template>
	<mescroll-uni @init="mescrollInit" :up="upOption" :down="downOption" @down="downCallback" @up="upCallback">
		...
		<view :style='{"width":"100%","padding":"20rpx 10rpx 70rpx","position":"relative","flexWrap":"wrap","background":"#f3f5f9","display":"flex"}'>
			<!--header end-->
			...
			<view class="list" :style='{"padding":"60rpx 20rpx","flex":"1"}'>
				...
				<view @tap="onDetailTap(item.id)" v-for="(item,index) in list " v-bind:key="index" :style='{"border":"0px solid #ddd","padding":"30rpx","margin":"0 0 20rpx","borderRadius":"0px","background":"#fff","display":"flex","width":"100%","justifyContent":"space-between"}'>
