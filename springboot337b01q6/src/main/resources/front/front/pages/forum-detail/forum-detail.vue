<template>
	<view :style='{"alignContent":"flex-start","width":"100%","padding":"0","flexWrap":"wrap","background":"#f3f5f9","display":"flex"}'>
		...
		<view :style='{"width":"calc(100% - 0px)","margin":"0 auto","fontSize":"28rpx","color":"#888","textAlign":"center","background":"#fff"}'>
		...
		<view :style='{"border":"0px solid #eee","padding":"20rpx","margin":"0 auto","borderRadius":"0 0 0px 0px","color":"#666","background":"#fff","width":"calc(100% - 0px)","fontSize":"30rpx","lineHeight":"48rpx"}'>
			<rich-text :nodes="forum.content"></rich-text>
		</view>
		<view :style='{"width":"calc(100% - 48rpx)","margin":"40rpx auto 168rpx","background":"none","order":"11"}'>
			<view :style='{"width":"100%","margin":"0 0 40rpx","borderRadius":"0px","background":"#fff"}' v-for="comment in commentData" :key="comment.id">
				...
				<view :style='{"border":"2rpx solid #eee","padding":"0 20rpx 20rpx 100rpx","fontSize":"28rpx","color":"#333","borderWidth":"0 0 2rpx"}'>
					...
					<view :style='{"width":"100%","alignItems":"center","justifyContent":"flex-end","display":"flex"}'>
						<text @tap="onReplyTap(comment.id)" :style='{"padding":"6rpx 20rpx","margin":"0 0px 0 0","color":"#fff","borderRadius":"4rpx","background":"#1ccb96","order":"2"}'>回复</text>
