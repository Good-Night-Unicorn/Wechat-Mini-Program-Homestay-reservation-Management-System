<template>
	<div :style='{"padding":"10px","fontSize":"15px"}'>
		...
		>
				...
				<el-form-item :style='{"border":"0px solid #eee","width":"100%","padding":"0","margin":"0 0 26px 0","display":"inline-block"}'   v-if="flag=='yonghu'"  label="身份证" prop="shenfenzheng">
					<el-input v-model="ruleForm.shenfenzheng" 						placeholder="身份证" clearable></el-input>
				</el-form-item>
				<el-form-item :style='{"border":"0px solid #eee","width":"100%","padding":"0","margin":"0 0 26px 0","display":"inline-block"}'   v-if="flag=='fangdong'"  label="民宿名称" prop="minsumingcheng">
					<el-input v-model="ruleForm.minsumingcheng" readonly						placeholder="民宿名称" clearable></el-input>
				</el-form-item>
				<el-form-item :style='{"border":"0px solid #eee","width":"100%","padding":"0","margin":"0 0 26px 0","display":"inline-block"}'   v-if="flag=='fangdong'"  label="法人" prop="faren">
					<el-input v-model="ruleForm.faren" 						placeholder="法人" clearable></el-input>
				</el-form-item>
				<el-form-item :style='{"border":"0px solid #eee","width":"100%","padding":"0","margin":"0 0 26px 0","display":"inline-block"}'   v-if="flag=='fangdong'"  label="联系方式" prop="lianxifangshi">
					<el-input v-model="ruleForm.lianxifangshi" 						placeholder="联系方式" clearable></el-input>
				</el-form-item>
				<el-form-item :style='{"border":"0px solid #eee","width":"100%","padding":"0","margin":"0 0 26px 0","display":"inline-block"}'   v-if="flag=='fangdong'"  label="民宿地址" prop="minsudizhi">
					<el-input v-model="ruleForm.minsudizhi" 						placeholder="民宿地址" clearable></el-input>
				</el-form-item>
				<el-form-item :style='{"border":"0px solid #eee","width":"100%","padding":"0","margin":"0 0 26px 0","display":"inline-block"}' v-if="flag=='fangdong'" label="logo" prop="touxiang">
					<file-upload
						tip="点击上传logo"
						action="file/upload"
						:limit="3"
...
export default {
	data() {
		...
		onUpdateHandler() {
			...
			if((!this.ruleForm.minsumingcheng)&& 'fangdong'==this.flag){
			...
			if( 'fangdong' ==this.flag && this.ruleForm.lianxifangshi&&(!isMobile(this.ruleForm.lianxifangshi))){
