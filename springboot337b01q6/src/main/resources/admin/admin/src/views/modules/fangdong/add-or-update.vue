		...
		>
			<template >
				...
				<el-form-item class="input" v-if="type!='info'"  label="法人" prop="faren" >
					<el-input v-model="ruleForm.faren" placeholder="法人" clearable  :readonly="ro.faren"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="法人" prop="faren" >
					<el-input v-model="ruleForm.faren" placeholder="法人" readonly></el-input>
				</el-form-item>
				...
				<el-form-item class="upload" v-if="type!='info' && !ro.touxiang" label="logo" prop="touxiang" >
					<file-upload
						tip="点击上传logo"
						action="file/upload"
						:limit="3"
				...
				<el-form-item class="upload" v-else-if="ruleForm.touxiang" label="logo" prop="touxiang" >
