				...
				<el-table
					...
					<el-table-column
						...
						<template slot-scope="scope">
							<el-button
								type="text"
								:style='{"border":"0px solid #000","cursor":"pointer","padding":"0 10px","margin":"0 5px 5px 0","color":"#fff","borderRadius":"4px","background":"#ffb800","width":"auto","fontSize":"14px","height":"32px"}'
								size="small"
