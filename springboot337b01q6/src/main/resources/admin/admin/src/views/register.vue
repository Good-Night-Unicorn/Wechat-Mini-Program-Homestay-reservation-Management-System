	...
	<div>
		<div class="register-container">
			<el-form v-if="pageFlag=='register'" ref="ruleForm" class="rgs-form animate__animated animate__zoomIn" :model="ruleForm" :rules="rules">
				<div class="rgs-form2">
					<div class="title">微信小程序民宿预订管理系统设计与实现</div>
					...
					<el-form-item class="list-item" v-if="tableName=='fangdong'">
						<div class="lable" :class="changeRules('minsumingcheng')?'required':''">民宿名称：</div>
					...
					<el-form-item class="list-item" v-if="tableName=='fangdong'">
						<div class="lable" :class="changeRules('faren')?'required':''">法人：</div>
						<el-input  v-model="ruleForm.faren"  autocomplete="off" placeholder="法人"  type="text"  />
					</el-form-item>
					<el-form-item class="list-item" v-if="tableName=='fangdong'">
					...
					<el-form-item class="list-item" v-if="tableName=='fangdong'">
						<div class="lable" :class="changeRules('minsudizhi')?'required':''">民宿地址：</div>
...
export default {
	...
	methods: {
		...
		login() {
			...
			if((!this.ruleForm.minsumingcheng) && `fangdong` == this.tableName){
			...
			if(`fangdong` == this.tableName && this.ruleForm.lianxifangshi &&(!this.$validate.isMobile(this.ruleForm.lianxifangshi))){
